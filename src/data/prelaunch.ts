...
export const prelaunch = {
  ...
  /* 사전신청자에게 줄 것이 정해지면 여기 한 줄을 채운다. 비워 두면 렌더되지 않는다.
     예: "사전신청하신 분들께 출시 후 프리미엄 3개월"

     BM이 서기 전에는 비워 두는 편이 낫다. 특히 "무료"는 쓰면 안 된다 —
     재생·스크립트·학습기록은 이미 무료라(product_scope.md 2절) 혜택이 아니라
     사실 서술이고, 나중에 단어장·오프라인을 유료로 붙일 때 발목을 잡는다.
     "먼저 초대"류도 스토어 출시라 순서를 통제할 수 없어 지킬 수 없는 약속이다. */
  perk: "",
